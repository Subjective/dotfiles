...
if is_available "smart-splits.nvim" then
  ...
  maps.n["<C-S-Up>"] = { "<cmd>resize -2<CR>", desc = "Resize split up" }
  maps.n["<C-S-Down>"] = { "<cmd>resize +2<CR>", desc = "Resize split down" }
  maps.n["<C-S-Left>"] = { "<cmd>vertical resize -2<CR>", desc = "Resize split left" }
  maps.n["<C-S-Right>"] = { "<cmd>vertical resize +2<CR>", desc = "Resize split right" }
end
