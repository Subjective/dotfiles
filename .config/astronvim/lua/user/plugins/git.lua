      ...
      vim.api.nvim_create_autocmd("FileType", {
        ...
        callback = function(event)
          ...
          require("which-key").register({
            ...
            pmm = { "<cmd>Octo pr merge commit<CR>", "Merge commits with the base branch" },
            pms = { "<cmd>Octo pr merge squash<CR>", "Squash commits into one commit and merge into the base branch" },
            pmd = { "<cmd>Octo pr merge delete<CR>", "Delete local and remote branch after merge" },
            pmr = { "<cmd>Octo pr merge rebase<CR>", "Rebase commits onto the base branch" },
